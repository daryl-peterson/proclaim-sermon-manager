...
class HooksUtils implements Initable {
	 ...
	 * @param int    $accepted_args number of hook accepts.
	 * @since 1.0.0
	 */
	public function remove_closure_hook( $name, $priority = 10, $accepted_args = 1 ): bool {
		 ...
		 * We know it's priority and number of parameters.
		 */
	 ...
	 */
	public function find_hook_callback_instances( string $hook_name, array $static_callback, $priority = null ): array {
		global $wp_filter;
